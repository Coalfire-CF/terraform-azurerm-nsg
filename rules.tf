variable "rules" {
  ...
  default = {
    #Nessus
    SSHfromBurp = ["Inbound", "Allow", "TCP", "*", "22", "SSHfromBurp"]
    WMIfromBurp = ["Inbound", "Allow", "TCP", "*", "445,139", "WMIfromBurp"]

    #Tower
    TowerLinux   = ["Inbound", "Allow", "TCP", "*", "22", "TowerLinux"]
    TowerWindows = ["Inbound", "Allow", "TCP", "*", "5985-5986", "TowerWindows"]
